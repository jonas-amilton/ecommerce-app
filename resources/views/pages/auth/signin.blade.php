                                    ...
                                    <div>
                                        ...
                                        <div class="relative" data-password-toggle>
                                            ...
                                            <button type="button"
                                                ...
                                                <svg data-password-icon-show class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <svg data-password-icon-hide class="hidden fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            document.querySelectorAll('[data-password-toggle]').forEach((container) => {
                const input = container.querySelector('input[name="password"]');
                const button = container.querySelector('[data-password-toggle-button]');
